...
def run_conversion(path='../Data/CrowdFlowerData/Football-Scenarios-DFE-832307.csv'):
...
def convert_and_insert(path='../Data/CrowdFlowerData/Football-Scenarios-DFE-832307.csv'):
